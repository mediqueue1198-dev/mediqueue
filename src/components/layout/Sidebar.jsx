...
import {
  ...
  Users, Settings, LogOut, Activity, UserCheck, ClipboardList,
  Stethoscope, ChevronRight, X, Heart, Search, DollarSign
} from 'lucide-react'
...
export function Sidebar() {
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div className={cn('p-5 text-white', ROLE_COLORS[role])}>
